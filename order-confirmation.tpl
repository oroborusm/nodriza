...
<div class="formCarrito formCarritoFinalCompra">
	...
	{if $is_guest}
	    ...
	    <p class="navegador">
			<a class="volverCompra" href="{$link->getPageLink('guest-tracking', true, NULL, "id_order={$reference_order|urlencode}&email={$email|urlencode}")|escape:'html':'UTF-8'}" title="{l s='Follow my order'}">
